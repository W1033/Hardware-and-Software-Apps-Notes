...
![image-20230609154400323](readme.assets/image-20230609154400323.png)
...
## ▲ PPT 插入图片后裁减超出当前版式的部分

在当前版式插入图片，然后画一个和当前版式大小的形状，然后点击 “开始 -> 排列 -> 选择窗格 ”，打开选择窗格之后，先选中矩形，再选中图片，然后点击菜单栏的 “形状格式 -> 合并形状 -> 相交” 即可。

![image-20240118160431682](./readme.assets/image-20240118160431682.png)
...
1. 选择“**视图**”>“**参考线**”可显示水平和垂直中心线。在视图(不在图片上)中右键可以添加参考线。
...
2. 显示红色虚线（智能指南），以便垂直、水平或两者对齐项目。 智能参考线也会显示在对象之间或靠近幻灯片边缘，以帮助你均匀地分隔对象。 
    ...
    ![PowerPoint 中的红色虚线对齐三个对象。](readme.assets/a658911e-d1c7-41c2-941f-e3548007d6df.png)
