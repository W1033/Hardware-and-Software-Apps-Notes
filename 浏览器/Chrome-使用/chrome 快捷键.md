...
注：MacOS 请把下面表格中的 `Ctrl` 换成 `Command`
...
| `Ctrl + J`                                              | 打开“下载内容”页面                                           |
| `Shift + Esc`                                           | 打开任务管理器                                               |
| `Shift + Alt + T`                                         | 将焦点设置在浏览器工具栏中的第一个工具上                     |
| `Tab`、`Shift + Tab`、`Home`、`End`、向右箭头和向左箭头 | 在工具栏中将焦点移到各个选项上                               |
| 空格键或 `Enter`                                      | 激活工具栏按钮，包括网页操作和浏览器操作                     |
| `Shift + F10`                                           | 打开相关右键菜单（例如，“后退”按钮关联的浏览历史记录）       |
| `Esc`                                                 | 将焦点从工具栏移回到网页上                                   |
| `F6` 或 `Shift + F6`                                    | 将焦点切换到下一个键盘可访问的窗格                           |
