...
- tape `/teɪp/` -n. 磁带；胶带；录音带。-v. 录音；粘贴；捆扎。
...
| 图标        | 中文名          | 英文名                      | 解释                  |
| -------------------------- | -------------------------- | -------------------------- | -------------------------- |
| ![image-20230211201539839_15](readme.assets/image-20230211201539839_15.jpg) | 媒体排序依据 (按钮)   | Sort Media By |                      |
| <img src="readme.assets/image-20230213122532698.png" alt="image-20230213122532698" style="zoom:43%; float:left;" /><img src="readme.assets/image-20230212202848675.png" alt="image-20230212202848675" style="zoom: 40%; float:left;" /> | 媒体夹 | Bin |                                                              |
|  | 时间码 | Timecode | |
|  | 摄影机 | Camera | |
|  | 日期时间 | Date Time | |
|  | 片段名 | Clip Name | |
...
| ![image-20230211201539839_32](readme.assets/image-20230211201539839_32.jpg) |      叠化      |     Dissolve     | ※ dissolve `/dɪˈzɑːlv/` <br />- v.（使）溶解；解散。<br />- n.淡入淡出。 |                                                              |
