...
“快编页面”为您提供了2种“时间线”显示方式。“时间线”面板上部区域永远显示完整的剪辑，即使“时间线”结构特别复杂，您也可以在这个面板中进行快速导航。“时间线”面板下部区域显示“播放头”位置附近区域的详细视图，方便您对多个单独片段执行精细编辑。  

<img>

有了这2种同时显示的视图，您就不需要花费时间在“时间线”上来回缩放找片段了。

<p style="background-color:#fdeed6; border-radius:6px; padding:20px;"><strong style="color:#f79c21;">提示：</strong>当面板区域调整时，下方“时间线”上显示的片段也会根据可用的显示面板空间自动改变高度。因此，如果“时间线”较复杂，您想让片段显示大一点，只需使用“调整时间线大小”功能调整用来显示“时间线”的屏幕空间的大小即可；片段显示的高度会动态跟随以适配“时间线”！</p>
...
#### (2) 时间线 "波形显示功能"
播放“时间线”至Chris露出笑容后，但在他说“My name is Chris Lang…（我叫Chris Lang……）”之前，停止播放。
