...
| 测光选项 | 说明                                                         |
| -------- | ------------------------------------------------------------ |
|          | **矩阵测光**：在大多数情况下可产生自然效果。照相机对画面的广泛区域进行测光，并根据色调分布、色彩、构图及距离信息`(1)`设定曝光。<br /> - (1) 使用 G 型、 E 型或 D 型镜头（Book 425 ）时，照相机使用 3D 彩色矩阵测光 III ；使用其他 CPU 镜头时，照相机使用彩色矩阵测光 III ，该测光方式不包括 3D 距离信息。 |
